...
import { idlFactory } from './lib.did.js';
export { idlFactory } from './lib.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.LIB_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./lib.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the lib canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./lib.did.js")._SERVICE>}
 */
export const lib = createActor(canisterId);
